...
public class Levels {
    ...
    public ArrayList<Sprite> levelsPrint1() {
        ...
        all.add(new Platform("platformDecor.png", 900, 500, 200, 30));
        ...
        all.addAll(coin);
        all.add(new IterBox("boxDecor.png", 700, 500, 150, 150, true, 1));
        all.add(new IterBox("boxDecor.png", 950, 400, 100, 100, true, 3));

        all.add(new Decor("homeDecor.gif", 0, 88, 200, 200, false));

        traps.add(new Trap("fairDecor.gif", 600, 120, 40, 40));
        all.addAll(traps);
    ...
    public ArrayList<Sprite> levelsPrint2() {
        ...
        all.add(new Platform("platformDecor.png", 150, 280, 200, 30));
    ...
    public ArrayList<Sprite> levelsPrint3() {
        ...
        all.add(new Platform("platformDecor.png", 200, 425, 400, 30));
        all.add(new Platform("platformDecor.png", 150, 300, 200, 30));
        all.add(new MovingPlatform("platformDecor.png", 700, 425, 200, 30, true, 200,10));
        ...
        traps.add(new Trap("fairDecor.gif", 500, 670, 40, 40));
        traps.add(new Trap("fairDecor.gif", 700, 170, 40, 40));
        all.addAll(traps);
    ...
    public ArrayList<Sprite> EndGame(){
        ...
        all.add(new Button("ButtonRestart.png", 100, 480, 80, 30, false, Definitions.defaultMovePress));
        all.add(new Platform("platformDecor.png", 20, 500, 300, 30));
        all.add(new Platform("platformDecor.png", 400, 600, 100, 30));
        all.add(new Platform("platformDecor.png", 20, 700, 1400, 30));
        return all;
    }
}
