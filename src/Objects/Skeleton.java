...
public class Skeleton extends Sprite {
    ...
    public Skeleton(int x, int y, int roamDist, ModelController modelController) {//roamDist = бродитьРасстояние
        ...
        walkingRight = true;
        framesSinceDeath = 0;
        Skeleton.modelController = modelController;
    }
    ...
    public void kill() {
        ...
        if (modelController != null) {
            modelController.setKillSkeleton();
        }
    }
