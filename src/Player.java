...
public class Player extends Sprite {
    ...
    public Player(){
        super("playerAll.png", Definitions.playerDimension, Definitions.playerDimension);
...
//        }
    ...
    public boolean overlaps(Sprite sprite){
        if (xPosition + imageWidth - Definitions.playerPadding < sprite.xPosition){
            return false;
        }
        if (xPosition + Definitions.playerPadding > sprite.xPosition + sprite.getWidth()){
            return false;
        }
